...
/// <summary>
/// BaseBOLLogs is the base class of Logs
/// </summary>
public class BaseBOLLogs : Logs, IBaseBOL<Logs>
{
    ...
    private string TableOrViewName = "vLogs";
    public string BaseID = "Logs";
    protected LogsDataContext dataContext;
    ...
    Logs IBaseBOL<Logs>.GetDetails(int Code)
    {
        return dataContext.Logs.Single(p => p.Code.Equals(Code));
    }
    ...
    public int SaveChanges(bool IsNewRecord)
    {
        ...
        {
            ObjTable = new Logs();
            dataContext.Logs.InsertOnSubmit(ObjTable);
        }
        else
        {
            ObjTable = dataContext.Logs.Single(p => p.Code.Equals(this.Code));
        }
        try
        {
    ...
    {
        get { return "Logs/EditLogs.aspx"; }
    }
    string IBaseBOL.ViewForm
    {
        get { return "Logs/ViewLogs.aspx"; }
    }
    ...
    DataTable IBaseBOL.GetDataSource(SearchFilterCollection sFilterCols, string SortString, int PageSize, int CurrentPage)
    {
        ...
        var ListResult = dataContext.ExecuteQuery<vLogs>(string.Format("exec spGetPaged '{0}','{1}','{2}','{3}',N'{4}'", TableOrViewName, SortString, PageSize, CurrentPage, WhereCond));
        DataTable dt = new Converter<vLogs>().ToDataTable(ListResult);
        return dt;
    }
    ...
    void IBaseBOL.DeleteRecord(params string[] DelParam)
    {
        ...
        if (tools.HasAccess("Edit", "Logs"))
        {
            Logs ObjTable = dataContext.Logs.Single(p => p.Code.Equals(DelParam[0]));
            dataContext.Logs.DeleteOnSubmit(ObjTable);
            dataContext.SubmitChanges();
        }
    }
