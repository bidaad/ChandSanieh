<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmallContentBox.ascx.cs"
    Inherits="AceNews.UserControls.SmallContentBox" %>
<div class="BoxGray">
        ...
        <asp:Repeater ID="rptItems" EnableViewState="false" runat="server">
            <ItemTemplate>
                <div class="SideNewItem">
                    <asp:HyperLink Target="_blank" NavigateUrl='<%#"~/News/" + Eval("Code") + ".htm" %>' runat="server">
